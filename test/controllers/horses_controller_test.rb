...
class HorsesControllerTest < ActionController::TestCase
  ...
  test "should create horse" do
    assert_difference('Horse.count') do
      post :create, horse: { dam_id: @horse.dam_id, name: @horse.name, sex: @horse.sex, sire_id: @horse.sire_id, year: @horse.year }
    end
  ...
  test "should update horse" do
    patch :update, id: @horse, horse: { dam_id: @horse.dam_id, name: @horse.name, sex: @horse.sex, sire_id: @horse.sire_id, year: @horse.year }
    assert_redirected_to horse_path(assigns(:horse))
  end
